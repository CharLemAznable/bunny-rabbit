...
public final class MtcpConfiguration {
    ...
    public void postConstruct() {
        ...
        MockDiamondServer.setConfigInfo("Bunny", "default",
                "httpserver.port=12224\n" +
                        "interceptors=@com.github.charlemaznable.bunny.rabbit.mtcp.MtcpInterceptor() " +
                        "@com.github.charlemaznable.bunny.rabbittest.mtcp.EmptyInterceptor() \n");
        MockDiamondServer.setConfigInfo("BunnyClient", "default",
                "httpServerBaseUrl=http://127.0.0.1:12224/bunny\n");
    }
